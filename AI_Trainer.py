# -*- coding: utf-8 -*-
"""
Created on Thu May 19 00:05:57 2022
...
gs_rf = joblib.load('RandomForest')
gs_rf
...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            body_lang_class = gs_rf.predict(x)[0] 
            body_lang_prob = gs_rf.predict_proba(x)[0] #predict the probability of the landmark location
        ...
        #left flexion bar
        cv2.rectangle(image, (580,400), (630,120), l_colour, -1)
        cv2.rectangle(image, (580,int(l_bar)), (630,120), (255,255,255), -1)
        
        #right flexion bar
        cv2.rectangle(image, (10,400), (60,120), r_colour, -1)
        cv2.rectangle(image, (10,int(r_bar)), (60,120), (255,255,255), -1)
        
        #left flex percentage
        cv2.putText(image, f'{int(l_per)}%', (580,460), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, l_colour, 2)
        
        #right flex percentage
        cv2.putText(image, f'{int(r_per)}%', (10,460), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, r_colour, 2)
        ...
        # Display Workout
        cv2.putText(image, 'Workout', (300,410), cv2.FONT_HERSHEY_COMPLEX_SMALL, 0.5, (255, 255, 255), 1, cv2.LINE_AA)
        cv2.putText(image, body_lang_class, (300,430), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, 
                    (255, 255, 255), 2, cv2.LINE_AA)

        
        # Display Probability
        cv2.putText(image, 'Probability', (180,410), cv2.FONT_HERSHEY_COMPLEX_SMALL, 0.5, (255, 255, 255), 1, cv2.LINE_AA)
        cv2.putText(image, str(round(body_lang_prob[np.argmax(body_lang_prob)],1)*100), 
                    (180,430), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (255, 255, 255), 2, cv2.LINE_AA)
